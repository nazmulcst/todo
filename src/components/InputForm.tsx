    ...
    <div>
      ...
      <form onSubmit={handleTodo} className='flex  items-center gap-4 h-10 md:h-14 relative'>
        <input type="text"
          ...
          className='lg:flex-1 h-full border-[1px]  border-gray-600 bg-transparent pl-4 pr-6 placeholder:text-gray-400 text-base placeholder:text-sm tracking-wide rounded-md
     outline-none hover:border-blue-400 duration-150'
        ...
        <button type='submit' className='h-full border-[1px] border-gray-600 
     px-2 rounded-md hover:text-orange-400 uppercase duration-200 text-sm md:text-base'>AddTodo</button>
      </form>
      {/* TodoList */}
      <TodoList/>
    </div>
